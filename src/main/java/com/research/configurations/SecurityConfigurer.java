...
public class SecurityConfigurer extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/project/*").access("hasAnyAuthority('ADMIN','USER')")
		.antMatchers("/lfm/*").access("hasAnyAuthority('ADMIN','USER')")
		.antMatchers("/employee/*").access("hasAuthority('ADMIN')")	
		.antMatchers("/payment/*").access("hasAuthority('ADMIN')")
		.antMatchers("/projectEmployees/*").access("hasAuthority('ADMIN')")
		.antMatchers("/projectTypes/*").access("hasAuthority('ADMIN')")
		.antMatchers("/sysUser/*").access("hasAuthority('ADMIN')")
