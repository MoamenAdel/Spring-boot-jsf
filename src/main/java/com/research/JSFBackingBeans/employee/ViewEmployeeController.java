...
@Scope(value = "view")
@Component(value = "ViewEmployeeController")
@ManagedBean(name = "ViewEmployeeController")
@ViewScoped
@Data
public class ViewEmployeeController implements Serializable {
	...
	public String editEmployee() {
        ...
        public String viewAssignedWeeks(){
            FacesContext.getCurrentInstance().getExternalContext().getFlash().put("employeeDto", employeeDto);
